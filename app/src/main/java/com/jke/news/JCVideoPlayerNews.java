...
public class JCVideoPlayerNews extends JCVideoPlayer {
    ...
    protected JCVideoPlayerNews.DismissControlViewTimerTask mDismissControlViewTimerTask;


    public JCVideoPlayerNews(Context context) {
        super(context);
    }

    public JCVideoPlayerNews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//            localLayoutParams.y = getContext().getResources().getDimensionPixelOffset(R.dimen.jc_volume_dialog_margin_left);
    ...
    public void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new JCVideoPlayerNews.DismissControlViewTimerTask();
